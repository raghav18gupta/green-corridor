...
while True:
    ...
    if lati_req is not None and longi_req is not None:
        ...
        g_api = 'https://maps.googleapis.com/maps/api/directions/json?origin=22.723840713500977, 75.88673400878906&destination={},{}&key=AIzaSyB4MRD0WcCY946DYNcISqg-vju7sK3TtqY'.format(lati_req, longi_req)
        print(g_api)
